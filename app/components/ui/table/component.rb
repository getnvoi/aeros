module Ui::Table
  class Component < ::Ui::ApplicationViewComponent
    ...
    class HeaderComponent < Ui::ApplicationViewComponent
      renders_many :columns, "ColumnComponent"

      class ColumnComponent < Ui::ApplicationViewComponent
        option(:css, optional: true)
    ...
    class RowComponent < Ui::ApplicationViewComponent
      option(:css, optional: true)

      renders_many :cells, "CellComponent"

      class CellComponent < Ui::ApplicationViewComponent
        option(:css, optional: true)
