module Ui
  module EngineHelpers
    # Sets up importmap for a Rails engine with UI gem integration
    #
    ...
    #       Ui::EngineHelpers.setup_importmap(self, namespace: YourEngine)
    #     end
    #   end
    def self.setup_importmap(engine_class, namespace:)
      engine_class.initializer "#{namespace.name.underscore}.importmap", before: "importmap" do |app|
        ...
        namespace.importmap.draw(Ui::Engine.root.join("config/importmap.rb"))
